...
public class ExampleFlock : MonoBehaviour
{
    [Header("Spawn Setup")]
    [SerializeField] private ExampleFlockUnit flockUnitPrefab;
    ...
    public ExampleFlockUnit[] allUnits { get; set; }
    ...
    private void Update()
    {
        ...
        MoveJobExmaple moveJob = new MoveJobExmaple
        {
        ...
        JobHandle handle = moveJob.Schedule(allUnits.Length, 1, sheduleJobDependency);
        handle.Complete();
    ...
    {
        allUnits = new ExampleFlockUnit[flockSize];
...
[BurstCompile]
public struct MoveJobExmaple : IJobParallelFor
{
    ...
    public void Execute(int index)
    {
        ...
        //Calculate aligement
        Vector3 aligementVector = unitForwardDirections[index];
